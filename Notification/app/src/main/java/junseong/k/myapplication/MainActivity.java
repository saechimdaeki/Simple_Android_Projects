    ...
    public void onClick(View view) {
       ...
       builder.setSmallIcon(android.R.drawable.ic_notification_overlay);
        ...
        if(view==bigPictureBtn){
            ...
            Person sender1=new Person.Builder().setName("김").setIcon(IconCompat.createWithResource(this,R.drawable.person1)).build();
            Person sender2=new Person.Builder().setName("KIMMMM").setIcon(IconCompat.createWithResource(this,R.drawable.person2)).build();
